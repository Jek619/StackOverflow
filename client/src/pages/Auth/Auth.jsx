        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="password">
           <div style={{display: 'flex', justifyContent: 'space-between'}}> 
            ...
            <input type='password' name='password' id='pasword' onChange={(e) => {setPassword(e.target.value)}} />
            { isSignup && <p style={{ color:"#666767", fontSize:"13px"}}>Password contain atleast eight<br /> characters, including 1 letter and 1 <br /> number </p>}
          </label>
          {
            isSignup && (
              <label htmlFor='check'>
